...
fn build_front_matter(chunk: &Chunk) -> Vec<u8> {
    ...
    log::debug!(
        ...
        crate::bridge::redact::redact(&meta.source_id),
        crate::bridge::redact::redact(source_scope),
...
mod tests {
    use super::*;
    use crate::store::chunks::types::{Metadata, SourceKind, SourceRef};
