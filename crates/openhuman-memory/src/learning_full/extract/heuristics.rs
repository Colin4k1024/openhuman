...
//!
//! Three detectors feed [`crate::learning_full::candidate::global()`]:
//!
...
//! intended to be called from [`crate::learning_full::ReflectionHook`] or a
...
mod heuristics_tests {
    use super::*;
    use crate::learning_full::candidate::{Buffer, FacetClass};
