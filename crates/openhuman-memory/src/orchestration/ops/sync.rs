...
use crate::orchestration::sync::{emit_sync_stage, MemorySyncStage, MemorySyncTrigger};
use crate::sync::composio::{self, SyncReason};
...
/// [`crate::orchestration::IngestionStatusSnapshot`] but is the public RPC
...
pub async fn memory_sync_channel(
    ...
    crate::bridge::events::publish_global(
        crate::bridge::events::MemoryEvent::MemorySyncRequested {
...
pub async fn memory_sync_all() -> Result<RpcOutcome<SyncAllResult>, String> {
    ...
    crate::bridge::events::publish_global(
        crate::bridge::events::MemoryEvent::MemorySyncRequested { channel_id: None },
    );
    emit_sync_stage(
        MemorySyncTrigger::Manual,
        MemorySyncStage::Requested,
...
pub async fn memory_ingestion_status() -> Result<RpcOutcome<IngestionStatusResult>, String> {
    let snapshot = match crate::orchestration::global::client_if_ready() {
...
mod tests {
    ...
    use crate::bridge::events::{MemoryEvent as DomainEvent, EventHandler};
    ...
    fn ensure_memory_client() -> crate::store::MemoryClientRef {
        crate::orchestration::ops::ensure_shared_memory_client();
        crate::orchestration::global::client().expect("memory client")
    }
    ...
    async fn memory_sync_channel_publishes_targeted_event() {
        let _serial = crate::orchestration::ops::GLOBAL_MEMORY_TEST_LOCK
            .lock()
            .await;
