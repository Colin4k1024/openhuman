...
use crate::tree::retrieval::types::{hit_from_chunk, RetrievalHit};
use crate::tree::score::store::get_scores_batch;
...
mod tests {
    ...
    async fn fetch_leaves_preserves_input_order_and_propagates_scores() {
        use crate::tree::score::signals::ScoreSignals;
        use crate::tree::score::store::{upsert_score, ScoreRow};
