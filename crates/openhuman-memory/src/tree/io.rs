...
//! compose the existing primitives from [`crate::store::trees`]
...
use crate::tree::tree::bucket_seal::LeafRef;
...
/// [`crate::tree::tree::bucket_seal::LabelStrategy`] in a
...
mod tests {
    use super::*;
    use crate::store::trees::TreeStatus;
