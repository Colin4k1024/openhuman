...
use crate::store::chunks::types::{approx_token_count, Chunk, SourceKind};
...
impl ScoringConfig {
    ...
    pub fn from_config(config: &crate::config::Config) -> Self {
        use crate::bridge::inference::build_chat_runtime;
        ...
        Self::with_llm_extractor(Arc::new(extract::LlmEntityExtractor::new(cfg, Arc::from(provider))))
    }
}
