...
use crate::bridge::inference::{build_chat_provider, ChatPrompt};
use crate::store::chunks::types::approx_token_count;
...
mod tests {
    ...
    struct UsageReportingProvider {
        response: String,
        usage: Option<crate::bridge::inference::UsageInfo>,
    }

    #[async_trait::async_trait]
    impl crate::bridge::inference::ChatProvider for UsageReportingProvider {
        fn name(&self) -> &str {
        ...
        async fn chat_for_text_with_usage(
            ...
            String,
            Option<crate::bridge::inference::UsageInfo>,
        )> {
    ...
    async fn summarise_threads_provider_usage_into_output() {
        use crate::bridge::inference::UsageInfo;
        use crate::bridge::inference::test_override;
