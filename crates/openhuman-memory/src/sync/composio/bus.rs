...
//!   [`crate::bridge::agent::triage::run_triage`] to produce a
//!   [`TriageDecision`] and then
//!   [`crate::bridge::agent::triage::apply_decision`] to act on it.
...
//!   the bus.
//!
//! [trigger_triage]: crate::bridge::agent_registry::agents
//!
//! ## Feature flag
//!
