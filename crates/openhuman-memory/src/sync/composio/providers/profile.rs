...
use crate::store::profile::{self, FacetType};
use rusqlite::params;
...
pub fn persist_provider_profile(profile: &ProviderUserProfile) -> usize {
    let Some(client) = crate::orchestration::global::client_if_ready() else {
        tracing::debug!(
...
mod tests {
    use super::*;
    use crate::store::profile::{profile_load_all, PROFILE_INIT_SQL};
