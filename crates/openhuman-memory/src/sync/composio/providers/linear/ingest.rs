...
use crate::orchestration::ingest_pipeline::{self, IngestResult};
use crate::store::chunks::store::{delete_chunks_by_source, is_source_ingested};
...
mod tests {
    ...
    async fn re_ingesting_edited_issue_replaces_prior_chunks() {
        use crate::store::chunks::store::count_chunks;
