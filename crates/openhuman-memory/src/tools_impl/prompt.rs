...
//! [`crate::bridge::agent::prompts::SystemPromptBuilder::build`]).
//!
...
//! the pattern used by
//! [`crate::bridge::agent::prompts::ReflectionMemoryContextSection`].
...
mod tests {
    use super::*;
    use crate::bridge::agent::prompts::types::{
        LearnedContextData, PromptContext, ToolCallFormat,
    };
    use crate::tools_impl::types::ToolMemorySource;
